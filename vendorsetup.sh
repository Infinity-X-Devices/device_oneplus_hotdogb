...
# Vendor
git clone --depth=1 https://github.com/Infinity-X-Devices/vendor_oneplus_hotdogb.git -b 15 vendor/oneplus/hotdogb
git clone --depth=1 https://github.com/Infinity-X-Devices/vendor_oneplus_sm8150-common.git -b 15 vendor/oneplus/sm8150-common 
